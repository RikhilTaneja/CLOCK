  ...
  return (
    <div id='navbar'>
      ...
      >
        ...
        <div id='navbar-right'>
            <Link style={{color: `${dark ? "#D0D5FA" : "#3B5B7C"}`}} className='nav-opt' to={"/"}>CLOCK</Link>
            <Link style={{color: `${dark ? "#D0D5FA" : "#3B5B7C"}`}} className='nav-opt' to={"/stopwatch"}>STOPWATCH</Link>
            <Link style={{color: `${dark ? "#D0D5FA" : "#3B5B7C"}`}} className='nav-opt' to={"/countdown"}>NEW YEAR COUNTDOWN</Link>
        </div>
    </div>
  )
}
